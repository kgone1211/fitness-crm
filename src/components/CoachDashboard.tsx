...
export default function CoachDashboard() {
  ...
  // Handler functions for Message and View buttons
  ...
  const handleSendMessage = () => {
    if (messageText.trim() && selectedClient) {
      ...
      alert(`Message sent to ${selectedClient.name}: "${messageText}"`);
      setMessageText('');
          ...
          <div className="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Fitness Progress</h4>
                  <div className="space-y-2 text-sm">
                    <div><strong>Current Weight:</strong> {selectedClient.currentWeight} lbs</div>
                    <div><strong>Goal Weight:</strong> {selectedClient.goalWeight} lbs</div>
                    <div><strong>Progress:</strong> {selectedClient.progress}%</div>
                    <div><strong>Last Check-in:</strong> {selectedClient.lastCheckIn}</div>
                    <div><strong>Workouts This Week:</strong> {selectedClient.workoutsThisWeek}</div>
                  </div>
                </div>
              </div>
